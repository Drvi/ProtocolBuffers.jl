            ...
            @testset "options = $options" begin
                @testset "google/protobuf/unittest.proto" begin
                    ...
                    @testset "include generated" begin
                        @test include(joinpath(tmpdir, "protobuf_unittest/ProtobufUnittestPB.jl")) isa Module
                    end
                end
                ...
                @testset "google/protobuf/unittest_proto3.proto" begin
                    ...
                    @testset "include generated" begin
                        @test include(joinpath(tmpdir, "proto3_unittest/Proto3UnittestPB.jl")) isa Module
                    end
                end
                ...
                @testset "datasets/google_message3/benchmark_message3.proto" begin
                    ...
                    @testset "include generated" begin
                        @test include(joinpath(tmpdir, "benchmarks/google_message3/GoogleMessage3PB.jl")) isa Module
                    end
                end
                ...
                @testset "datasets/google_message4/benchmark_message4.proto" begin
                    ...
                    @testset "include generated" begin
                        @test include(joinpath(tmpdir, "benchmarks/google_message4/GoogleMessage4PB.jl")) isa Module
                    end
                end
                ...
                @testset "google/protobuf/test_message_proto2.proto" begin
                    ...
                    @testset "include generated" begin
                        @test include(joinpath(tmpdir, "protobuf_test_messages/ProtobufTestMessagesPB.jl")) isa Module
                    end
                end
